...
must purchase [GeoIP2 web service](https://www.maxmind.com/en/geoip2-precision-services) queries and
...
- MaxMind’s most accurate IP geolocation data – GeoIP2 web service data accurately
...
- This release updates the API to use version 2.1 of our GeoIP2 web
service.
...
<ReleaseNote date="2014-07-18" title="GeoIP2 Web Service v2.1">
