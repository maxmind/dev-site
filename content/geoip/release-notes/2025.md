...
{{< release-note date="2025-07-29" title="Off-schedule release for GeoIP City, GeoIP Country, and GeoIP Enterprise databases" >}}

On Monday, July 28, 2025, we issued an off-schedule release of the following GeoIP databases:

- GeoIP City
- GeoIp Country
- GeoIP Enterprise

We issued this off-schedule release to correct a number of poorly formatted or incorrect postal codes.
