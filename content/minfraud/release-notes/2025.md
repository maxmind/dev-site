---
draft: false
title: minFraud Release Notes - 2025 Archive
type: release-note
...
[`email/domain` sub-object](https://dev.maxmind.com/minfraud/api-documentation/responses/#email--domain)
...
[Client APIs](https://dev.maxmind.com/minfraud/evaluate-a-transaction#links-to-maxmind-client-apis)
...
[View the full list of possible values for `event/type` on our developer portal.](https://dev.maxmind.com/minfraud/api-documentation/requests/#schema--request--event__type)
