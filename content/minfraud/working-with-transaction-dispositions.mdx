...
your <a href="https://www.maxmind.com/en/accounts/current/license-key">MaxMind
account ID</a>. The password is your <a
href="https://www.maxmind.com/en/accounts/current/license-key">MaxMind license
key</a>. You must be approved for a trial or purchase credit for use with our
...
| PERMISSION_REQUIRED    | 403 Forbidden              | You do not have permission to use the service. Please contact <a href="mailto:support@maxmind.com">support@maxmind.com</a> for more information. |
