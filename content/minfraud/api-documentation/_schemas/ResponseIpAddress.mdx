...
1. minFraud Insights and Factors return the following anonymous IP outputs: _
   `is_anonymous` _ `is_anonymous_vpn` _ `is_hosting_provider` _
   `is_public_proxy` _ `is_residential_proxy` _ `is_tor_exit_node`
