...
We are removing suffixes (AB, A/S, Co, Corp, eood, Pte, Pvt, and S. de R.L.)
from ISP/org names to match their current naming and branding conventions. We
expect to release these changes in new database updates and web service requests
beginning Tuesday, March 10, 2026. Some of the larger ISPs that will be updated
include:

| Current ISP name in MaxMind data | Updated ISP name in MaxMind data |
| -------------------------------- | -------------------------------- |
| `GlobalConnect AB`               | `GlobalConnect`                  |
| `GlobalConnect A/S`              | `GlobalConnect`                  |
| `SoftBank Corp`                  | `SoftBank`                       |
| `Bredband2 AB`                   | `Bredband2`                      |
| `Bahnhof AB`                     | `Bahnhof`                        |
