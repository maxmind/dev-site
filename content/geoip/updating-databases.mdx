...
Where `YOUR_ACCOUNT_ID` is a placeholder for your account’s actual account ID
and `YOUR_LICENSE_KEY` is a placeholder for your account’s actual license key.
