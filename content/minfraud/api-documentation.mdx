...
and the
[API response body documentation](https://dev.maxmind.com/minfraud/api-documentation/responses#bodies).
...
[You can submit your support request on our knowledge base.](https://share.hsforms.com/1wsOwiZ3LS1WlrB72grq0kAcntle)
