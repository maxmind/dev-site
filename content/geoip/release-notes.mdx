...
“New England.” In such cases, we will map IP addresses to a state in the
geographic center of the region, and will update the `accuracy_radius` and
`subdivision_confidence` values appropriately.
