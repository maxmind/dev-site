...
It is expected for database files to increase in size from time to time between
releases. As we incorporate data corrections and new data sources, we will add
entries to our databases, and you should develop your integration with the
expectation that these changes will occur.
