...
documentation on our [knowledge base](https://support.maxmind.com/hc/en-us/articles/4408801942811-Use-Custom-Rules-and-Dispositions).
...
be `accept`ed or `reject`ed, and/or have a note added. [Learn how to use the
account portal to do manual review on our knowledge
base.](https://support.maxmiind.com/hc/en-us/articles/4408762136603-Review-a-minFraud-Transaction).
