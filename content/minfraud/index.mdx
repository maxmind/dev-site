...
<LinkGroupContainer>
  ...
  <LinkGroup isCompact heading="Resources">
    ...
    <LinkGroupCard
      description="Consult our knowledge base for articles about using minFraud."
      heading="Knowledge Base"
      icon={FaQuestionCircle}
      to="https://support.maxmind.com/hc/en-us/categories/1260801482329-minFraud-Web-Services"
    />
