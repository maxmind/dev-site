...
The proxy detection web service provides a score measuring the risk associated with an IP address. Learn more about the proxyScore (called the IP Risk Score in current minFraud services) [on our Support 
