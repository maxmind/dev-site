...
Please note, the original URIs have been deprecated. Support for these URIs will
be removed in the future:

- `https://geoip.maxmind.com/a`
- `https://geoip.maxmind.com/b`
- `https://geoip.maxmind.com/f`
- `https://geoip.maxmind.com/e`

Please update your integration to use the official URIs listed below.
