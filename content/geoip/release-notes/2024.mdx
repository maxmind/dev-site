...
[See the Monthly Diff Report for January 2024.](https://dev.maxmind.com/geoip/release-notes/2024#geonames-monthly-diff-report-january-2024)
...
increase the security and reliability of our services. You should make sure that
your downloading servers don't have any proxies or firewall settings that would
block the host we are redirecting to.
