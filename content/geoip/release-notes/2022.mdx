...
<ReleaseNote date="2022-09-26" title="Changes to Registered Country data">
...
[You can learn more about the `/registered_country` output in the API schema for
GeoIP2 web services.](/geoip/docs/web-services/responses?lang=en#schema--response--registered-country)

[You can learn more about the difference between registered country and the IP
geolocation on our Knowledge Base.](https://support.maxmind.com/hc/en-us/articles/4414762983195-Country-level-and-City-level-Geolocation)
</ReleaseNote>

<ReleaseNote date="2022-09-14" title="Change to Time Zone Name for Ukraine">
The time zone name for Kyiv, Ukraine, which covers most of the country,
has been updated.

Previously, the time zone was named `Europe/Kiev`. It has been updated
to be named `Europe/Kyiv` following updated naming conventions from
version 2022b of the IANA time zone database.
...
<ReleaseNote date="2022-09-12" title="GeoNames Monthly Diff Report September 2022">
...
<ReleaseNote date="2022-09-12" title="Geolocation Bug Fix Complete">
...
<ReleaseNote date="2022-09-07" title="Updated GeoIP2 Enterprise Database Available">
