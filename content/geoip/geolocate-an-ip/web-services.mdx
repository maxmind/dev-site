...
libraries](/geoip/docs/web-services?lang=en#api-clients) to access our
geolocation services. If you cannot or do not wish to use our client libraries,
please review our [GeoIP2 API Documentation
page](/geoip/docs/web-services/#request-and-response-api-references) for details
on our REST API.
...
GeoIP2 offers 3 services: Insights, City Plus, and Country.  GeoLite2
