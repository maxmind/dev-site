...
endpoint](/minfraud/report-transaction-api/). This will allow you to more
...
the following [Anonymous IP outputs](/geoip/api-documentation) as parameters to
...
You can find descriptions of these outputs [here](/geoip/api-documentation).
</ReleaseNote>
...
form](https://www.maxmind.com/en/accounts/current/minfraud/tag-transactions).
</ReleaseNote>
