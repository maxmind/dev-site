...
You may also [download these codes in CSV format](/csv-files/codes/country-continent).
...
You may also [download these codes in CSV format](/csv-files/codes/ap_country_list).
