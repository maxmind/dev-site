...
{{< release-note date="2025-01-20" title="metro_code deprecation in GeoIP" >}}

The `metro_code` data in our GeoIP products and services is a no-longer-maintained code for targeting advertisements in Google. Because Google does not use or publish these codes any longer, the `metro_code` field has now been deprecated in our GeoIP products and services.
