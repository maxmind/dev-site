...
We now update GeoIP2 Country, City, ISP, and Enterprise databases twice weekly
on Tuesdays and Fridays (instead of weekly). We made this change so that data
corrections and location updates can be deployed more quickly.
