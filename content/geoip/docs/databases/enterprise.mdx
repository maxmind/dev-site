...
We maintain example files in CSV and MMDB format. We maintain example files in
CSV and MMDB format. The files contain dummy data rather than real GeoIP data.

### CSV example files

This zip file contains examples of all GeoIP2 Enterprise CSV files as they would
be downloaded from the account portal:
