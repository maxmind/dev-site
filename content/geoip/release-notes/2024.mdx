...
Due to irregulaties in the latest data, we will not be releasing a GeoNames
Monthly Diff Report for this month.

We will be maintaining the GeoNames data from last month.
