...
available in the GeoIP2 Insights web service or the GeoIP2 Anonymous
IP database.
...
GeoIP2 Insights includes the average income and population density for
...
GeoIP2 Insights also includes `user_count`, an estimate of the number
...
[GeoIP2 web service](/geoip/docs/web-services). The API calls the web
...
Unlike the GeoIP Legacy web service, the GeoIP2 web services use HTTP
...
This is an example of our GeoIP2 Insights web service's return
document.
