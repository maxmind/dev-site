---
draft: false
title: GeoIP IP Risk binary database fields
---

The GeoIP IP Risk binary database contains the following fields for each network.
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          ...
          current list of VPN providers identified in the IP Risk
