...
The GeoIP Connection Type and GeoIP Domain Name databases and all GeoLite databases (except GeoLite ASN) will continue to update only on Tuesdays and Fridays.
