...
postal codes in the United Kingdom.
    ...
    <tr>
      ...
      <td>string</td>
      <td>
        <p><strong>Deprecated. This field will be empty in the updated legacy web service. See our <a href="https://blog.maxmind.com/2020/06/15/data-changes-to-geoip-legacy-and-minfraud-legacy-web-services-in-may-2022/">blog post detailing changes to our legacy web services</a>.</strong></p></td>
      <td></td>
      <td></td>
      <td><FaCheck /></td>
      <td><FaCheck /></td>
