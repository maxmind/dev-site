...
The following is an example of a full response to a GeoIP2 Country request.
...
The following is an example of a full response to a GeoIP2 City Plus
request.
...
The following is an example of a full response to a GeoIP2 Insights request.
