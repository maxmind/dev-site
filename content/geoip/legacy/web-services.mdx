...
<p>
  For customers who have not yet updated their integration to reflect the changes detailed in the above blog post, we provide a <a href="https://www.maxmind.com/download/geoip/misc/region_codes.csv">CSV file which maps
...
the <a href="https://dev.maxmind.com/static/csv/codes/time_zone.csv">list of possible values</a>.
