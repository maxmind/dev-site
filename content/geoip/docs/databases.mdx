...
<LinkGroupContainer>
  <LinkGroup>
    <LinkGroupCard
      ...
      icon={DatabaseIcon}
      to="/geoip/databases/city-and-country"
    />
    ...
    <LinkGroupCard
      ...
      icon={DatabaseIcon}
      to="/geoip/databases/anonymous-ip"
    />
    ...
    <LinkGroupCard
      ...
      icon={DatabaseIcon}
      to="/geoip/databases/connection-type"
    />
