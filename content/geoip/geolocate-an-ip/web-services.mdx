---
draft: false
title: Geolocate an IP using MaxMind Web Services
---

Geolocating an IP using MaxMind web services consists of configuring a web
service client, creating a request, and handling the response.
