...
This zip file contains examples of all GeoIP2 Domain CSV files as they would be
downloaded from the account portal:

- [GeoIP2-Domain-CSV_Example](/static/GeoIP2-Domain-CSV_Example.zip)
