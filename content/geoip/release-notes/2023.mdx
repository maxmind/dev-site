...
Tomorrow, on Tuesday August 29, 2023 we will be adding a new connection type
value, `Satellite`, which will identify satellite internet providers such as
Starlink, Viasat, and Hughes. Satellite connections typically have higher
latency than cable/DSL connections.
...
- [Update Java API to version 4.1.0](https://central.sonatype.com/artifact/com.maxmind.geoip2/geoip2/4.1.0)
