...
must purchase
[GeoIP2 web service](https://www.maxmind.com/en/geoip-api-web-services) queries
and either upgrade to the
...
[GeoIP2 Web Service](https://www.maxmind.com/en/geoip-api-web-services) lookups.
Individuals unable to purchase services are encouraged to use our free GeoLite2
Country or City databases. {{</ release-note >}}
