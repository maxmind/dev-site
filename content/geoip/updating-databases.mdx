...
There are two methods for automatially updating GeoIP2 and GeoIP Legacy binary
databases:
...
Get a partially [pre-filled configuration
file](https://www.maxmind.com/en/accounts/current/license-key/GeoIP.conf) (may
require authentication) and save it in your configuration directory (e.g.,
...
This is only recommended for systems unable to use GeoIP Update program or for
clients using the CSV-format databases.
...
request for that database’s download permalink URL, as found on our [database
