...
These zip files are examples of GeoIP2 City CSV and GeoIP2 Country CSV zip files
as they would be downloaded from the account portal:

- [GeoIP2-City-CSV_Example](/static/GeoIP2-City-CSV_Example.zip)
- [GeoIP2-Country-CSV_Example](/static/GeoIP2-Country-CSV_Example.zip)

### MMDB example files

TODO: Add Country

<MmdbFileExamples link="https://github.com/maxmind/MaxMind-DB/blob/main/test-data/GeoIP2-City-Test.mmdb" product="GeoIP2-City-Test.mmdb" />
