...
Please note, the original URI, `https://minfraud.maxmind.com/app/ccv2r`, has
been deprecated. Support for this URI will be removed in the future.

Please update your integration to use the official URI listed below.
