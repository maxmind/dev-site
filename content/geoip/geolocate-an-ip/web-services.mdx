...
libraries](#official-api-clients) to access our geolocation services. If you cannot or do not wish to use our client libraries, please review our [GeoIP2 API Documentation page](//geoip/api-documentation) for details on our JSON API.
...
key](https://www.maxmind.com/en/accounts/current/license-key).  Our clients also allow you to interact with our GeoLite2 API, but this requires additional configuration as demonstrated below:
