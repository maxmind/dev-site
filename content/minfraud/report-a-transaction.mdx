...
required, but you are encouraged to provide it or the transaction’s `maxmind_id`
or `minfraud_id`.
...
| AUTHORIZATION_INVALID | 401 Unauthorized           | You have supplied an invalid [MaxMind account ID and/or license key](https://www.maxmind.com/en/my_license_key) in the [Authorization](#authorizationsecurity) header.                                                                                                            |
| LICENSE_KEY_REQUIRED  | 401 Unauthorized           | You have not supplied a [MaxMind license key](https://www.maxmind.com/en/my_license_key) in the [Authorization](#authorizationsecurity) header.                                                                                                                                   |
| ACCOUNT_ID_REQUIRED   | 401 Unauthorized           | You have not supplied a [MaxMind account ID](https://www.maxmind.com/en/my_license_key) in the [Authorization](#authorizationsecurity) header.                                                                                                                                    |
