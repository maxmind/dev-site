...
{{< release-note date="2024-12-17" title="GeoLite data now available through the Snowflake Marketplace" >}}
...
updates and web service requests beginning Tuesday, December 17, 2024.
...
We are updating several ISP names in our data to match their current naming
and branding conventions. We expect to release these changes in new database 
updates and web service requests beginning Tuesday, November 26, 2024.
...
the databases on November 5, 2024 and make adjustments to your thresholds before
...
confidence to make decisions, you may want to monitor your application starting
on November 5, 2024 and make adjustments to thresholds as necessary.
