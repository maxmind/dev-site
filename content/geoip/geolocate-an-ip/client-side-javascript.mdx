...
Our GeoIP2 JavaScript client allows you to use GeoIP2 web services
...
* If successful, this function calls the `onSuccess` callback. The
  ...
  of one of MaxMind’s [GeoIP2 web service API
...
Version 2.1 of the JavaScript API uses version 2.1 of the [GeoIP2 web
