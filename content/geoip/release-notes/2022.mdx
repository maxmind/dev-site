...
<ReleaseNote date="2022-09-07" title="Geolocation Coordinate Bug Fix for GeoIP">
We are aware of a bug in which GeoIP2 databases and web services have been
returning [geolocation location
...
GeoIP2 database users should download this update when it becomes available.

GeoIP web service users will see the corrected data as soon as the fix has
been implemented.
