...
You may be using the original URI, `https://minfraud.maxmind.com/app/ccvr2`.
...
you access, you can login to your Sandbox account and click on
“minFraud Version” in the minFraud section of the left-hand navigation menu
[[direct
link](https://sandbox.maxmind.com/en/accounts/current/minfraud/legacy-version),
...
`https://minfraud.sandbox.maxmind.com/minfraud/v1.0/legacy`

If you are using the original URI, you can also test using that URI on the
Sandbox:

`https://minfraud.sandbox.maxmind.com/app/ccvr2`
