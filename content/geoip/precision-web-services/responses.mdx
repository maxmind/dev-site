  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        document with two keys, code and error. See the [Errors](/geoip/web-services/responses/#errors)
...
object. No other language is guaranteed. However, it possible that we might not
have any name data at all for a given object.

### Returned Values as Database, Map, Dict, or Hash Keys

<Alert type="warning">
  We strongly discourage your from using a value from any `names` field as a key
