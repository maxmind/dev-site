...
1. If the domain ends with a TLD that appears to be a typo of `.com`, it is
   replaced with `.com`. For the exact expression we use to determine this,
...
1. Fix common typos in domain names. You can see a list of typos we map in our
   [Java client API](https://github.com/maxmind/minfraud-api-java/blob/main/src/main/java/com/maxmind/minfraud/request/Email.java#L26).
...
- [Java](https://github.com/maxmind/minfraud-api-java/blob/main/src/main/java/com/maxmind/minfraud/request/Email.java#L169)
...
- [Python](https://github.com/maxmind/minfraud-api-python/blob/main/minfraud/request.py#L83)
