...
import errorResponseJson from './_examples/response-error.json';
import factorsResponseJson from './_examples/response-factors.json';
import insightsResponseJson from './_examples/response-insights.json';
import scoreResponseJson from './_examples/response-score.json';
  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        document with two keys, code and error. See the [Errors](#) section for
        more details.
      </td>
    </tr>
    <tr>
...
<Example language="json">
  {JSON.stringify(scoreResponseJson, null, 2)}
</Example>

### Insights Body
<Example language="json">
  {JSON.stringify(insightsResponseJson, null, 2)}
</Example>

### Factors Body
<Example language="json">
  {JSON.stringify(factorsResponseJson, null, 2)}
</Example>

### Error Body
<Example language="json">
  {JSON.stringify(errorResponseJson, null, 2)}
</Example>
