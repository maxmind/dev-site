...
This zip file contains examples of all GeoIP2 Connection Type CSV files as they
would be downloaded from the account portal:

- [GeoIP2-Connection-Type-CSV_Example](/static/GeoIP2-Connection-Type-CSV_Example.zip)
