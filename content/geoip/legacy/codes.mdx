...
You may also [download these codes in CSV format](/csv-files/codes/iso3166.csv).
...
You may also [download these codes in CSV format](/csv-files/codes/country_continent.csv).
...
You may also [download these codes in CSV format](/csv-files/codes/eu_country_list.csv).
...
You may also [download these codes in CSV format](/csv-files/codes/ap_country_list.csv).
