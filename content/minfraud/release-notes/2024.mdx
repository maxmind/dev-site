...
<ReleaseNote date="2024-09-12" title="Increase in slightly elevated IP risk and proxy scores and remediation">
...
<ReleaseNote date="2024-08-27" title="Introducing Risk Score Reasons beta for minfraud Factors customers">
...
<ReleaseNote date="2024-08-15" title="MaxMind minFraud alert emails now include instant feedback links">
...
<ReleaseNote date="2024-08-08" title="Additional filtering options now available for minFraud transactions">
