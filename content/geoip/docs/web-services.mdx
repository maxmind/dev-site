...
<Alert type="info">
  If you are a legacy GeoIP customer, please see our
  [What's New in GeoIP2](https://dev.maxmind.com/geoip/geoip2/whats-new-in-geoip2/)
  document for a general overview of the changes from legacy GeoIP to GeoIP2.
</Alert>
...
<LinkGroupContainer heading="References">
  <LinkGroup>
    ...
    <LinkGroupCard
      heading="Responses"
      icon={FaUpload}
      to="/minfraud/web-services/responses"
    />
  </LinkGroup>
</LinkGroupContainer>
