...
- City – maps the IP address to a specific city within a country. In the US, we
  ...
  contains approximate latitude, longitude, and time zone data. \*Organization –
  maps the IP address to the organization which was assigned the IP address’s
  netblock.
...
latest CSV formats, please see our [GeoIP2 Databases](/goeip/docs/databases).
</Alert>
