...
<MmdbFileExamples link="https://github.com/maxmind/MaxMind-DB/blob/main/test-data/GeoIP2-Connection-Type-Test.mmdb" product="GeoIP2-Connection-Type-Test.mmdb" />
