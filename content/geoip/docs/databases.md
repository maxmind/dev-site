...
| Erlang                  | locus                           | [Hex](https://hex.pm/packages/locus)                                                        | [HexDocs](https://locus.hexdocs.pm/)                                               | [GitHub](https://github.com/g-andrade/locus)                 |
...
| Python (Rust extension) | maxminddb-rust                  | [PyPI](https://pypi.org/project/maxminddb-rust/)                                            | [README](https://github.com/oschwald/maxminddb-rust-python/blob/main/README.md)    | [GitHub](https://github.com/oschwald/maxminddb-rust-python)  |
| Python (Zig extension)  | maxminddb-zig                   | [PyPI](https://pypi.org/project/maxminddb-zig/)                                             | [README](https://github.com/marselester/maxminddb.py/blob/main/README.md)          | [GitHub](https://github.com/marselester/maxminddb.py)        |
...
| Ruby (Rust extension)   | maxmind-db-rust                 | [RubyGems](https://rubygems.org/gems/maxmind-db-rust)                                       | [README](https://github.com/oschwald/maxmind-db-rust-ruby/blob/main/README.md)     | [GitHub](https://github.com/oschwald/maxmind-db-rust-ruby)   |
...
| Data Processing                | DataFusion              | [GeoIP scalar function](https://github.com/datafusion-contrib/datafusion-dft/blob/main/docs/features.md#net---featuresnet) |
